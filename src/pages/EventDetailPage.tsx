...
import { Calendar, Clock, MapPin, User, ExternalLink, Eye, Heart, Share2, ArrowLeft } from 'lucide-react';
...
const EventDetailPage: React.FC = () => {
  ...
  const { events, toggleLike, likedEvents, incrementViews } = useEvents();
        ...
        <main className="flex-grow pt-24 pb-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative mb-8">
              ...
              />
              <div className="absolute top-4 right-4 bg-violet-600 text-white px-4 py-2 rounded-full text-sm font-medium">
                {event.category}
              </div>
            </div>
                ...
                <div className="bg-white rounded-lg shadow-lg p-6 sticky top-24">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start">
                      <Calendar className="h-5 w-5 text-violet-600 mr-3 mt-0.5" />
                      <div>
                    ...
                    <div className="flex items-start">
                      <MapPin className="h-5 w-5 text-violet-600 mr-3 mt-0.5" />
                      <div>
                    ...
                    <div className="flex items-start">
                      <User className="h-5 w-5 text-violet-600 mr-3 mt-0.5" />
                      <div>
